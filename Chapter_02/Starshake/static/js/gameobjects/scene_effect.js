export default class SceneEffect {
  ...
  /*
   This adds a rectangle to the scene, and then we tween
   it to make it move from the left to the right.
    */
  ...
  /*
    This adds a rectangle to the scene, and then we tween
    it to make it move from the right to the left.
    */
  simpleOpen(callback) {
    const rectangleWidth = this.scene.width / 2;
    const rectangle1 = this.scene.add
  ...
  /*
    This adds two rectangles to the scene, and then we tween
    them to make them move from the center to the left and right.
    */
  close(callback) {
    const rectangleWidth = this.scene.width / 2;
    const rectangle1 = this.scene.add
